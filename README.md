[![Build Status](https://dev.azure.com/VRamirezBarrera/ContosoAir/_apis/build/status/vladimirramirez.ContosoAir?branchName=master)](https://dev.azure.com/VRamirezBarrera/ContosoAir/_build/latest?definitionId=1&branchName=master)
